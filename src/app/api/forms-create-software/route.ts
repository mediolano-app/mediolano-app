...
export async function POST(request: NextRequest) {
  try {
    ...
    const attributes = [
      ...
      { trait_type: "Developer", value: developer },
      { trait_type: "Version", value: versionCode },
      { trait_type: "Release Date", value: releaseDate },
      { trait_type: "Programming Language", value: progammingLanguage },
      { trait_type: "Source Code", value: sourceCode },
      { trait_type: "Documentation", value: documentation },
      { trait_type: "Repository", value: repository },
      ...
      { trait_type: "File-Count", value: filesCount.toString() },
      { trait_type: "Protection-Status", value: protectionStatus },
      { trait_type: "Scope", value: protectionScope },
      { trait_type: "Duration", value: protectionDuration },
