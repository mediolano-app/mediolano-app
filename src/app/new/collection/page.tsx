...
import { deployCollectionContract } from '@/lib/onchain/deployCollection'
...
export default function NewCollectionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Deploy on-chain collection contract
      const txHash = await deployCollectionContract(collection.name, ipfsHash)

      setSubmissionResult({
        success: true,
        message: `Collection created successfully! IPFS Hash: ${ipfsHash}, Transaction Hash: ${txHash}`,
      })
    } catch (error: any) {
