...
import { ChevronRight, ShieldCheck, Scale, AlertOctagon, FileCheck, Globe, Lock, Coins, ArrowUp, Briefcase, Gavel, BookOpen, UserCheck } from "lucide-react"
...
export default function ComplianceGuidelinesContent() {
