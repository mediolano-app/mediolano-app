  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-background shadow rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg text-muted-foreground">Artwork Template</h2>
        </div>
      </div>
              ...
              <TabsContent value="details" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                     ...
                     <Input id="format" placeholder="Enter medium type" {...form.register("format")} />
                   </div>  
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="dimensions" placeholder="Enter dimensions" {...form.register("dimensions")} />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="created" className="flex items-center gap-1">
                    Created
                    </Label>
                    <Input id="created" placeholder="Enter creation iformation" {...form.register("created")} />
                        ...
                        <CardContent>
                            <ul className="space-y-4">
                                <li className="flex items-center">
                                    ...
                                    <span>
                                        Global exposure to art collectors
                                    </span>
                                </li>
                                <li className="flex items-center">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ul className="grid grid-cols-2 gap-4">
                                ...
                                <li className="flex items-center">
                                    <BoxIcon className="h-5 w-5 text-primary mr-2 flex-shrink-0" />
