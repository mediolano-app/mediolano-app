  ...
  return (
    <div className="min-h-screen py-10 mb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <Link href="/create/templates" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="bg-white dark:bg-black mt-1 block w-full rounded-md  shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                />
              </div>
              <div>
          ...
          <div className="bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/50 text-foreground shadow-md rounded-lg p-6">
