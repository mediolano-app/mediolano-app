                    ...
                    <Label htmlFor="tags" className="flex items-center gap-2">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              Add tags to help others discover your IP. Press
                              Enter or comma to add each tag.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                ...
                {!useMediaUrl ? (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Upload the files that represent your intellectual
                        property
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Provide a URL to your media content
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        <Alert>
                          ...
                          <AlertDescription>
                            <ul className="list-disc list-inside space-y-1 text-sm">
                              ...
                              <li>
                                For images: use direct links to JPG, PNG, or
                                WebP files
                              </li>
                              <li>
                                For videos: use direct links or embedding URLs
                                from platforms like Vimeo or YouTube
                              </li>
                              <li>
                                For audio: use direct links to MP3 or WAV files
                              </li>
                              <li>
                                For documents: link to PDF or other document
                                formats
                              </li>
                            </ul>
                          </AlertDescription>
              ...
              <TabsContent value="rights" className="space-y-4 mt-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Define the rights and licensing terms for your
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Version number to track updates to your intellectual
                        property
                      </p>
                    </div>
                  ...
                  <div className="space-y-4">
                      ...
                      >
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              You retain all rights to your work. Others must
                              obtain your permission for any use.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            <Label
                              htmlFor="creative-commons"
                              className="font-medium"
                            >
                              Creative Commons
                            </Label>
                            <p className="text-sm text-muted-foreground">
                              Allow others to use your work with certain
                              restrictions like attribution or non-commercial
                              use.
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Allow others to use, modify, and distribute your
                              work freely, typically for software.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label htmlFor="commercial-use">
                              Commercial Use
                            </Label>
                            <p className="text-sm text-muted-foreground">
                              Allow others to use your IP for commercial
                              purposes
                            </p>
                          </div>
                          <Checkbox
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        Your IP will be registered on the Starknet blockchain
                        and protected under The Berne Convention in 181
                        countries. This provides immutable proof of ownership
                        with a timestamp.
                      </AlertDescription>
                    </Alert>
                  </CardContent>
            ...
            <Card className="sticky top-6 bg-muted/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your IP will be protected in 181 countries according to The
                    Berne Convention
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Immutable timestamp on Starknet blockchain, settled on
                    Ethereum
                  </p>
                </div>
                <div className="space-y-1">
          ...
          <div className="px-4 py-6">
                  ...
                  <div className="md:col-span-1 flex justify-center">
                    <div className="relative aspect-video w-full max-w-md rounded-lg overflow-hidden border bg-muted">
                      ...
                      Object.keys(previewUrls).length > 0 ? (
                        <img
                          src={
                            Object.values(previewUrls)[0] || "/background.jpg"
                          }
                          alt="IP Preview"
                          className="object-cover w-full h-full"
                        />
            ...
            {transactionStatus === "processing" && (
              <div className="flex flex-col items-center justify-center py-10">
                ...
                <h3 className="text-lg font-medium mb-2">
                  Minting Your IP Asset
                </h3>
                <p className="text-sm text-muted-foreground text-center max-w-md">
                  Please wait while your intellectual property is being
                  registered on the Starknet blockchain. This process creates an
                  immutable record of your ownership.
                </p>
            ...
            {transactionStatus === "success" && (
              <div className="flex flex-col items-center justify-center py-10">
                ...
                <p className="text-sm text-muted-foreground text-center max-w-md mb-6">
                  Please confirm with your encrypted wallet to successfully
                  register on the blockchain with immutable proof of ownership.
                </p>
            ...
            {transactionStatus === "error" && (
              <div className="flex flex-col items-center justify-center py-10">
                ...
                <p className="text-sm text-muted-foreground text-center max-w-md mb-6">
                  There was an error while registering your IP on the
                  blockchain. This could be due to network congestion or wallet
                  connection issues.
                </p>
                <div className="flex gap-3">
                  <Button
                    variant="outline"
                    onClick={() => setTransactionStatus("waiting")}
                  >
                    Try Again
                  </Button>
                  <Button
