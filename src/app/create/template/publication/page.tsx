  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-background shadow rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg text-muted-foreground">Publication Template</h2>
        </div>
      </div>
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              ...
              <TabsContent value="details" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="isbn" placeholder="Enter isbn information" {...form.register("isbn")} />
