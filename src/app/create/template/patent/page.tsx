  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-background shadow rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
        <h1 className="text-lg font-bold">Create Programmable IP</h1>
        <h2 className="text-lg text-muted-foreground">Patent Template</h2>
        </div>
      </div>
              ...
              <TabsContent value="details" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2 mt-4">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="patent" className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                     ...
                     <Input id="author" placeholder="Enter author type" {...form.register("author")} />
                   </div>  


                  <div className="space-y-2">
                    <Label htmlFor="inventor" className="flex items-center gap-1">
                    Inventor(s)
                    </Label>
                    <Input id="inventor" placeholder="Enter inventor name" {...form.register("inventor")} />

                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="patentType" className="flex items-center gap-1">
                    Patent Type
                    </Label>
                    <Input id="patentType" placeholder="Enter patent type" {...form.register("patentType")} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="patentNumber" placeholder="Enter patent number" {...form.register("patentNumber")} />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="status" placeholder="Enter status information" {...form.register("status")} />
                  </div>


                  <div className="space-y-2">
                    <Label htmlFor="filingDate" className="flex items-center gap-1">
                    Date
                    </Label>
                    <Input id="filingDate" type="filingDate" {...form.register("filingDate")} />
                  </div>
          ...
          <Card className='bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/50 text-foreground'>
            ...
            <CardContent>
              <ul className="grid grid-cols-2 gap-4">
                ...
                <li className="flex items-center">
                  <Power className="h-5 w-5 text-primary mr-2 flex-shrink-0" />
