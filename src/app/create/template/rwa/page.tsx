...
const formSchema = z.object({
  ...
  type: z.enum(["rwa", "other"]),
  rwa: z.string().optional(),
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-background shadow rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-bold">Create Programmable IP - RWA Template</h1>
      </div>
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              ...
              <TabsContent value="details" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                     <Label htmlFor="rwa" className="flex items-center gap-1">
                     RWA Type
                     </Label>
                     <Input id="rwa" placeholder="Enter rwa type" {...form.register("rwa")} />
                   </div>  
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="location" placeholder="Enter location" {...form.register("location")} />

                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="valuation" className="flex items-center gap-1">
                    Valuation
                    </Label>
                    <Input id="valuation" placeholder="Enter valuation" {...form.register("valuation")} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="insurance" placeholder="Enter insurance information" {...form.register("insurance")} />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="structure" placeholder="Enter structure information" {...form.register("structure")} />
                  </div>
