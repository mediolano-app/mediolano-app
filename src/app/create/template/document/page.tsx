...
export default function CreateIPPage() {
  ...
  const handleSignTransaction = async () => {
    try {
      ...
      try {
        const response = await fetch("/api/forms-create-document", {
          method: "POST",
          headers: {
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-background shadow rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg text-muted-foreground">Document Template</h2>
        </div>
      </div>
              ...
              <TabsContent value="details" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                     ...
                     <Input id="format" placeholder="Enter format type" {...form.register("format")} />
                   </div>  
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="author" placeholder="Enter author name" {...form.register("author")} />

                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="categories" className="flex items-center gap-1">
                    Categories
                    </Label>
                    <Input id="categories" placeholder="Enter categories" {...form.register("categories")} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="publisher" placeholder="Enter publisher information" {...form.register("publisher")} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="expiration" type="expiration" {...form.register("expiration")} />
                  </div>


                  <div className="space-y-2">
                    <Label htmlFor="publilanguagesher" className="flex items-center gap-1">
                    Language
                    </Label>
                    <Input id="language" placeholder="Enter language information" {...form.register("language")} />
                  </div>
      ...
      <div className="space-y-8 mt-10">
          <Card className='bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/50 text-foreground'>
            <CardHeader>
              <CardTitle>Why Register Your document?</CardTitle>
            </CardHeader>
            <CardContent>
