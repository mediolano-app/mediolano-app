...
const formSchema = z.object({
  ...
  type: z.enum(["software", "other"]),
  developer: z.string().optional(),
  versionCode: z.string().optional(),
  releaseDate: z.string().optional(),
  progammingLanguage: z.string().optional(),
...
export default function CreateIPPage() {
  ...
  const { contract } = useContract({
    abi: abi as Abi,
    address:
      env.NEXT_PUBLIC_CONTRACT_ADDRESS_MIP as `0x${string}`,
  });
  ...
  const handleSignTransaction = async () => {
    try {
      ...
      const assetData = {
        ...
        progammingLanguage: formData.progammingLanguage,
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-background shadow rounded-lg">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-bold">Create Programmable IP - Software Template</h1>
      </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="space-y-2 mt-4">
                   ...
                   <div className="space-y-2">
                     ...
                     <Input id="developer" placeholder="Enter developer or company" {...form.register("developer")} />
                   </div>  


                  <div className="space-y-2">
                    <Label htmlFor="versionCode" className="flex items-center gap-1">
                      Version Code
                    </Label>
                    <Input id="versionCode" placeholder="Enter version code" {...form.register("versionCode")} />
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="progammingLanguage" className="flex items-center gap-1">
                      Programming Language
                    </Label>
                    <Input id="progammingLanguage" placeholder="Enter programming language" {...form.register("progammingLanguage")} />

                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="sourceCode" className="flex items-center gap-1">
                      Source Code
                    </Label>
                    <Input id="sourceCode" placeholder="Enter source code link" {...form.register("sourceCode")} />
                  </div>


                  <div className="space-y-2">
                    <Label htmlFor="documentation" className="flex items-center gap-1">
                      Documentation
                    </Label>
                    <Input id="documentation" placeholder="Enter documentation link" {...form.register("documentation")} />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="repository" placeholder="Enter repository link" {...form.register("repository")} />
                  </div>               
