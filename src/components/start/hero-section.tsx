...
export default function StartHeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center pt-20 pb-10">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            >
              Protect & Monetize Your <span className="text-gradient">Intellectual Property</span>
            </motion.h1>

            <motion.p variants={itemVariants} className="text-lg text-foreground/80 max-w-xl mx-auto lg:mx-0 mb-8">
              Mediolano empowers creators and organizations to tokenize, protect, and profit from their intellectual
              assets with blockchain technology.
            </motion.p>
          ...
          >
            <div className="relative w-full max-w-[280px] md:max-w-[400px] mx-auto aspect-square">
              {/* Central platform */}
              <motion.div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-28 h-28 md:w-36 md:h-36 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full flex items-center justify-center z-10 border border-primary/30 shadow-[0_0_30px_rgba(var(--primary-rgb),0.2)]"
                animate={{
                  boxShadow: [
