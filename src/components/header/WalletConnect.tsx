    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="w-full">
          <Wallet className="h-4 w-4" /> {isConnected ? currentAddress?.slice(0, 6) : "Connect"}
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm text-blue-500">
            {isConnected
              ? `Connected: ${currentAddress?.slice(0, 6)}...${currentAddress?.slice(-4)} ${invisibleAccount ? "(Invisible)" : ""}`
        ...
        <div className="grid gap-4">
          ...
          {isConnected ? (
            ...
            <div className="grid gap-4">
              ...
              {/* Argent Invisible Wallet section */}
              ...
              <div className="alert alert-warning">
                <p className="text-sm">
                 * Mediolano Dapp is under development and connected to the testnet. Please make sure your wallet is connected on <strong>Starknet Sepolia</strong> to interact.
                </p>
              </div>
