...
import { ArrowRight, Shield, Briefcase, FileText, Zap, Users, Layers, Lock, Music, Palette, Video, Book, DollarSign, Repeat, Search, Key, ChevronRight } from 'lucide-react'
...
function FeaturesSection() {
  const features = [
    ...
    { icon: <Layers className="w-12 h-12 mb-4 text-primary" />, title: "Multi-chain Support", description: "Operate across multiple blockchain networks" },
  ]
...
function HowItWorksSection() {
  const steps = [
    ...
    { icon: <Key className="w-12 h-12 text-primary" />, title: "Smart Licensing", description: "Create programmable licenses for flexible monetization." },
    ...
    { icon: <Zap className="w-12 h-12 text-primary" />, title: "Automated Transactions", description: "Execute IP transactions using smart contracts." },
  ]
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
            ...
            <p className="text-lg md:text-xl mb-6">
              Transform your intellectual property into dynamic, programmable assets on the blockchain. Mediolano's innovative approach allows for:
            </p>
            <ul className="list-disc list-inside space-y-2 mb-6">
              <li>Automated royalty distributions</li>
...
function LicensingProgrammableIPSection() {
  const features = [
    { icon: <Music className="w-8 h-8 text-primary" />, title: "Music Licensing", description: "Set up royalty splits and usage-based licensing for your tracks." },
    { icon: <Palette className="w-8 h-8 text-primary" />, title: "Art Licensing", description: "Control how your digital art is used and monetized across platforms." },
    { icon: <Video className="w-8 h-8 text-primary" />, title: "Video Content", description: "Manage distribution rights and revenue sharing for your videos." },
    { icon: <Book className="w-8 h-8 text-primary" />, title: "Literary Works", description: "Set up flexible licensing terms for your written content." },
    { icon: <DollarSign className="w-8 h-8 text-primary" />, title: "Royalty Management", description: "Automate royalty collection and distribution to rights holders." },
    { icon: <Repeat className="w-8 h-8 text-primary" />, title: "Trading & Transfer", description: "Easily trade or transfer partial or full rights to your IP." },
  ]
...
function RegisteringIPSection() {
  const benefits = [
    ...
    { icon: <Search className="w-8 h-8 text-primary" />, title: "Enhanced Discovery", description: "Make your IP easily discoverable by potential licensees and collaborators." },
    { icon: <Zap className="w-8 h-8 text-primary" />, title: "Active Control", description: "Maintain control over how AI companies and others can use your assets." },
    { icon: <Layers className="w-8 h-8 text-primary" />, title: "Modular Assets", description: "Transform static IP into modular, programmable digital assets." },
  ]
